...
const Home = () => {
  ...
  return (
  <>
	<section id="introPage" className="bg-none text-white relative z-[2] grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14">
        ...
        <div key={id}>
         ...
         >
          ...
          <div className="flex-1 flex justify-between gap-4 items-center">
            <div
              className="ml-auto rounded-full cursor-pointer hover:text-slate-950 duration-200 relative after:absolute after:top-0 after:h-0 after:right-full after:w-full after:h-full after:bg-white after:duration-200 hover:after:translate-x-full after:z-[-1] overflow-hidden"
            >
