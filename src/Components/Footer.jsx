...
export default function Footer() {
  ...
  >
    { locale === "FR" ?
        <p className="px-4 py-2 bg-white text-slate-950 font-medium"> Me connecter &darr;</p>
    :
    ...
    <div className="flex flex-col gap-4 items-center justify-center">
      ...
      <p>
        ...
        <a className="text-rose-400" href="https://github.com/Creiwry" rel='noreferrer' target="_blank"
          >Creiwry <sup
      ...
      <p>
        ...
        <a className="text-rose-400" href="https://www.linkedin.com/in/jaygardos/" rel='noreferrer' target="_blank"
          >Jay Gardos <sup
            ><span className="text-xs scale-75 pl-0.5"
              ><i className="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]" /></span
            ></sup
